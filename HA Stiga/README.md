...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/TanerCRB/StigaLawnMower?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=StigaLawnMower&category=integration)
...
1. Download the `custom_components/stiga_lawn_mower/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=stiga_lawn_mower)
...
Find all entities in **Settings** → **Devices & Services** → **StigaLawnMower** → click on the device.
...
### `stiga_lawn_mower.example_action`
...
```yaml
service: stiga_lawn_mower.example_action
data:
  # Add your parameters here
```

### `stiga_lawn_mower.reload_data`
...
```yaml
service: stiga_lawn_mower.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → StigaLawnMower → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@TanerCRB][user_profile]**
